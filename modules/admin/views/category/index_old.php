            ...
            <div class="panel-options">
                ...
                <ul class="nav nav-tabs">
                    ...
                    foreach ($langs as $lang): $n++; ?>
                        <li class="<?= $n == 1 ? "active" : '' ?>"><a data-toggle="tab"
                                                                      href="#tab-<?= $lang->id ?>"><?= $lang->language ?></a>
                        </li>
                    <?php endforeach; ?>
                                                ...
                                                <div class="panel-heading">
                                                    ...
                                                    <h5 class="panel-title" style="height:30px;">
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                                           href="#collapse<?= $cat->id ?>"><span
                                                                    class="<?= $cat->icon ?>"></span> <?= $cat->name ?>
                                                        </a>
                                                        ...
                                                        <div class='checkboxcustom pull-right'
                                                             style="margin-right:10px;">
                                                            <input type='checkbox' <?= $cat->status == 1 ? 'checked' : '' ?>
                                                                   onchange='statuschanger(<?= $cat->id ?>)'
                                                                   style="top:-8px;">
                                                        </div>
                                                ...
                                                <div id="collapse<?= $cat->id ?>" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        ...
                                                        <?php foreach (\app\models\Category::find()->where(['parent_id' => $cat->id])->orderBy(['sort' => SORT_ASC])->all() as $item): ?>
                                                            ...
                                                            <div class="row"
                                                                 style="margin:5px; padding:10px; background: #f5f5f5">
                                                                <div class="col-md-8"
                                                                     style="font-size:16px; color:#000; margin-top:5px;">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <a href="<?= Yii::$app->urlManager->createUrl(['/admin/category/delete', 'id' => $item->id]) ?>"
                                                                       class="pull-right"
                                                                       style="color:#000; margin-top:4px;"
                                                                    ...
                                                                    <button type="button"
                                                                            ...
                                                                            style="padding:0 7px; margin-top:4px;"
                                                                            onclick="updatemodal(<?= $item->id ?>)">
                                                                        <span class="fa fa-edit fa-2x"></span></button>
