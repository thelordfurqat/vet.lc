...
?>
<section class="mg-fea-area over" style="background-image:url('/front-theme/img/post/IMG_1294.jpg');">
    <div class="overlay">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        ...
                                        <div class="item <?=$k==0?'active':''?>">
                                            <a class="ta-slide-items" href="<?=Url::to(['/site/view','code'=>$item->code])?>">
                                                <div class="mg-blog-img" style="position: relative;width: 100%; max-height: 475px; ">
                                                    <a class="ta-slide-items" href="<?=Url::to(['/site/view','code'=>$item->code])?>">
                                                        <img src="/uploads/<?=$item->image?>" style="width:100%; ">
                                                    </a>
                                                </div>
